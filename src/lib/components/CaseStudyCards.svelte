<section class="py-24 bg-white border-t border-gray-200 font-sans">
    <div class="max-w-7xl mx-auto px-4 text-center mb-16">
        <span class="text-[10px] font-bold text-gray-500 uppercase tracking-widest border border-gray-200 px-3 py-1.5 rounded-full bg-gray-50">Erfolge in Zahlen</span>
        <h2 class="mt-8 text-5xl md:text-6xl font-serif-display text-gray-900">Keine Versprechungen. <br/> Echte Ergebnisse.</h2>
    </div>
    ...
    <div class="text-center mt-16">
        <h3 class="text-4xl font-serif-display mb-8">Jetzt sind Sie dran.</h3>
